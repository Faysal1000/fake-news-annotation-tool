...
- **Submitting Data**: When you are done annotating, send your `dataset.csv` file and your `images/` and `videos/` folders to your project lead.
- **Aggregating Data**: Project leads can combine work from multiple annotators. Put everyone's folders into one master folder, open the Annotator Tool, click **"Scripts"** (top right), and select **"Aggregate Datasets"**.
